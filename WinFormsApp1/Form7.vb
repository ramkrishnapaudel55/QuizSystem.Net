...
Public Class Form7
    ...
    Private Sub LoadQuestions()
        Try
            Using connection As New SqlConnection(connectionString)
                connection.Open()
                Dim query As String = "SELECT QuestionID, QuestionText, Option1, Option2, Option3, Option4 FROM HistoryQuestions ORDER BY QuestionID"
    ...
    Private Function GetCorrectOption(questionIndex As Integer) As Integer
        ...
        Try
            Using connection As New SqlConnection(connectionString)
                connection.Open()
                Dim query As String = "SELECT CorrectOption FROM HistoryQuestions WHERE QuestionID = @QuestionID"
                Using command As New SqlCommand(query, connection)
