...
Public Class Form8
    ...
    Dim connectionString As String = "Data Source=LAPTOP-OIMBR982\SQLEXPRESS;Initial Catalog=SportsQuestionsDB;Integrated Security=True"
    ...
    Private Sub LoadQuestions()
        Try
            Using connection As New SqlConnection(connectionString)
                connection.Open()
                Dim query As String = "SELECT QuestionID, QuestionText, Option1, Option2, Option3, Option4 FROM SportsQuestions ORDER BY QuestionID"
    ...
    Private Function GetCorrectOption(questionIndex As Integer) As Integer
        ...
        Try
            Using connection As New SqlConnection(connectionString)
                connection.Open()
                Dim query As String = "SELECT CorrectOption FROM SportsQuestions WHERE QuestionID = @QuestionID"
                Using command As New SqlCommand(query, connection)
