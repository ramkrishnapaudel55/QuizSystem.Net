...
Public Class Form6
    ...
    Dim connectionString As String = "Data Source=LAPTOP-OIMBR982\SQLEXPRESS;Initial Catalog=MathQuestionsDB;Integrated Security=True"
    ...
    Private Sub LoadQuestions()
        Try
            Using connection As New SqlConnection(connectionString)
                connection.Open()
                Dim query As String = "SELECT QuestionID, QuestionText, Option1, Option2, Option3, Option4 FROM MathQuestions ORDER BY QuestionID"
    ...
    Private Function GetCorrectOption(questionIndex As Integer) As Integer
        ...
        Try
            Using connection As New SqlConnection(connectionString)
                connection.Open()
                Dim query As String = "SELECT CorrectOption FROM MathQuestions WHERE QuestionID = @QuestionID"
                Using command As New SqlCommand(query, connection)
